...
if __name__ == "__main__":    
    ...
    baseline_polarization_path = f'LTM_networks/ws/5000/16/0/0/polarization_base.csv'
    #eval_file_props_path = f'Evaluation/ws/1000/8_props_baseline.csv'
    eval_file_polarization_path = f'LTM_networks/ws/5000/16/0/0/polarization.csv'
