...
#* Curves to plot
curve_list = []
#curve_i = (<network_root>,<network_class>,<N>,<K>,<w>,<Tau>)

'''
curve_list.append(("LTM","ws",1000,16,0))
curve_list.append(("LTM","ws",1000,16,1))
curve_list.append(("LTM","ws",1000,16,2))
curve_list.append(("LTM","ws",1000,16,4))
curve_list.append(("LTM","ws",1000,16,8))
curve_list.append(("LTM","ws",1000,16,16))
curve_list.append(("LTM","ws",1000,16,32))
curve_list.append(("LTM","ws",1000,16,64))

curve_list.append(("LTM","ws",1000,8,1,32))
curve_list.append(("LTM","ws",1000,8,5,32))
curve_list.append(("LTM","ws",1000,8,10,32))
curve_list.append(("LTM","ws",1000,8,20,32))
curve_list.append(("LTM","ws",1000,8,50,32))
curve_list.append(("LTM","ws",1000,8,100,32))
'''
curve_list.append(("LTM","mhk",1000,8,1,32))
curve_list.append(("LTM","mhk",1000,8,5,32))
curve_list.append(("LTM","mhk",1000,8,10,32))
curve_list.append(("LTM","mhk",1000,8,20,32))
curve_list.append(("LTM","mhk",1000,8,50,32))
curve_list.append(("LTM","mhk",1000,8,100,32))
...
for curve in curve_list:
    ...
    polarization_file = f'{network_root}/{network_type}/{n_nodes}/{neighbor_k}/{tau}/{seed}{frac}polarization.csv'
...
for idx,p in enumerate(curve_data[0][2][::-1]):
    ...
    for data in curve_data:
        ...
        #print(mpol.loc[ix[p,:,network_type],f'{cascade}'])  
        ...
        ## Legend and title
        legend0 = axs.legend(title=r' $  w  $', framealpha=1, facecolor='white',loc=[1.1,0],edgecolor='w',borderpad=0.2,markerscale=0.8,handlelength=1.4,handletextpad=0.4,fontsize=7)
    ...
    if save:
        fig_path = f'figs/selective_plot/{network_type}/{n_nodes}/{neighbor_k}'
        if not os.path.exists(fig_path):
            os.makedirs(fig_path)
        fig.savefig(fig_path + f'/c={cascade}_p={p}.pdf')
        print('fig saved')
    else:
        fig.show()