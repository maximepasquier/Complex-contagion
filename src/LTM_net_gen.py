...
probabilities = np.logspace(0.0,1.0,11)/10
#print(probabilities)
...
for n in N:        
    for k in K:
        for t in Tau:
            ...
            polarization_file = f'{network_root}/{network_type}/{n}/{k}/{t}/polarization.csv'
            network_path = f'{network_root}/{network_type}'
            ...
            config['Configuration'] = {'cascade': cascades, 'threshold' : threshold, 'probabilities' : probabilities, 'Alphas' : Alphas, 'Nodes' : n, 'Neighbors' : k, 'Memory' : t, 'Network type' : network_type}
            ...
            for p in realization_counter:
                ...
                # Create new networks, until the disired number of realizations is achieved
                    ...
                    while realization_counter[p] < desired_realizations:
                        ...
                        G.save(f'{network_root}/{network_type}/{G.gp.ID}.gt')
