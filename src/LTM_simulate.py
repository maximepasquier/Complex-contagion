    ...
    for n in N:        
        for k in K:
            ...
            for t in Tau:
                ...
                print()
                print("Running simulation : network_type =",network_type,", N =",n,", K =",k,", t =",t)
                print()
                ...
                for graph_path in list(get_recursive_graph_paths(f'Networks/{network_type}/{n}/{k}'))[:]:
                    ...
                    for seed in seed_nodes:
                        ...
                        infected_vectormap,waiting_dict, _, _ = linear_threshold_memory_model(G,threshold,t,weights,seed_nodes=[seed])
