...
#* Curves to plot
curve_list = []
#curve_i = (<network_root>,<network_class>,<N>,<K>,<Tau>)
...
curve_list.append(("LTM","ws",1000,8,0))
curve_list.append(("LTM","ws",1000,8,1))
curve_list.append(("LTM","ws",1000,8,2))
curve_list.append(("LTM","ws",1000,8,4))
curve_list.append(("LTM","ws",1000,8,8))
curve_list.append(("LTM","ws",1000,8,16))
curve_list.append(("LTM","ws",1000,8,32))
curve_list.append(("LTM","ws",1000,8,64))
